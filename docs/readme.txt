...
--------------------------------------------
    ...
    DOS version 7.x (WindowsÆ 95/98) or higher
...
compatibility testing: Ali (general) Fard and Bjîrn Wiklund.
...
their help (both valuable and less valuable):
    ...
    also thanks to Jonas, Kajsa, Malte, Rasmus and Johanna WersÑll
    and to my math teachers Christer Hedlund and èke Andersson
